/**
 * India: State -> District dataset for the cascading address dropdown
 * on Register / Complete Profile / Edit Profile.
 *
 * Mandal (aka Taluk/Tehsil/Block depending on the state) is intentionally
 * a free-text field, not a third dropdown here - there are several
 * thousand of them across India and they get redrawn/renamed often
 * enough that shipping a hardcoded list would go stale fast. State and
 * District are the two levels stable enough to hardcode.
 *
 * This list is best-effort and may be missing very recent district
 * splits in some states - edit the arrays below to add/rename any.
 */
const INDIA_LOCATIONS = {
    "Andhra Pradesh": ["Alluri Sitharama Raju","Anakapalli","Anantapur","Annamayya","Bapatla","Chittoor","East Godavari","Eluru","Guntur","Kakinada","Konaseema","Krishna","Kurnool","NTR","Nandyal","Palnadu","Parvathipuram Manyam","Prakasam","S.P.S. Nellore","Sri Sathya Sai","Srikakulam","Tirupati","Visakhapatnam","Vizianagaram","West Godavari","YSR Kadapa"],
